...
$$ is called a well-formed formulas (WFF). FORM defines all possible entries in our propositional logic.
...
*(Definition)* $\tau$ is a function that maps the PROP to $\{0,1\}$, or $\tau \in 2^{\mathsf{PROP}}$.
